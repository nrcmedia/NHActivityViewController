//
//  OWActivityListViewController.m
//  Extra Extra
//
...
@interface OWActivityListViewController ()
@property (strong, nonatomic) OWActivityListView *activityView;
@property (assign, nonatomic) BOOL isPresentingModally;
@property (strong, nonatomic) UIView* backgroundView;
@end

@implementation OWActivityListViewController
...
- (void)loadView {
    ...
    self.activityView = [[OWActivityListView alloc] initWithFrame:CGRectMake(0,
